package org.dalol.aisapirest.view;
...
import org.dalol.aisapirest.controller.Controller;
import org.dalol.aisapirest.model.adapter.AlunosAdapter;
...
public class MainActivity extends AppCompatActivity implements Controller.FlowerCallbackListener {
    ...
    private List<Alunos> mAlunosList = new ArrayList<>();
    private AlunosAdapter mAlunosAdapter;
    ...
    private void configViews() {
        ...
        mAlunosAdapter = new AlunosAdapter(mAlunosList);
    ...
    private void addFlowers() {
        for(int i = 0; i  < 1000; i++) {
            ...
            mAlunosAdapter.addFlower(alunos);
        }
    }
    ...
    @Override
    public void onFetchProgress(Alunos alunos) {
        mAlunosAdapter.addFlower(alunos);
    }

    @Override
    public void onFetchProgress(List<Alunos> alunosList) {
